...
class PtTransformer(nn.Module):
    ...
    def __init__(
        ...
        active_learning_method, # adaptive or uniform
    ...
    def forward(self, video_list):
        ...
        if self.half_enable:
            batched_inputs = batched_inputs.half()  # Convert inputs to FP16
            batched_masks = batched_masks.half()  # Convert masks to FP16
