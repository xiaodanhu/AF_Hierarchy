...
def main(args):
    ...
    if val_dataset_name in ('finegym_slide', 'finediving_slide', 'thumos14_slide') and not args.saveonly:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--val_dataset', type=str, default=None, choices=['finegym_original', 'finegym_slide', 'finediving_slide', 'thumos14_slide'])
